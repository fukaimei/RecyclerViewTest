...
public class StaggeredGridRVAdapter extends RecyclerView.Adapter<StaggeredGridRVAdapter.ViewHolder> {
    ...
    public StaggeredGridRVAdapter(Context context, List<MovieDataModel> mList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_movie_staggered_grid, parent, false);
