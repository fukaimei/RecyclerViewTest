...
public class GridLayoutRVActivity extends BaseActivity {
    ...
    private GridLayoutRVAdapter adapter;
    ...
    private void parsingMovieListJson() {
        ...
        adapter.setItemClikListener(new GridLayoutRVAdapter.OnItemClikListener() {
            @Override
